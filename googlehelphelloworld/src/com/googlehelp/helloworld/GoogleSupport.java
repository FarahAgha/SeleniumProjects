...
public class GoogleSupport {
	...
	public void launchURL() {
		...
		WebElement targetPageCheck = driver.findElement(By
				.xpath(".//div[normalize-space() = 'How can we help you?']"));
	...
	public void SupportSearch() {
		...
		WebElement searchButtonClick = driver.findElement(By
				.xpath("//form[@id='search-form']/button"));
		searchButtonClick.click();

		WebElement targetPageCheck = driver.findElement(By
				.xpath("//div[@class = 'heading']"));
